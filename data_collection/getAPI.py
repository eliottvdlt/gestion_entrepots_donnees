...
class MongoDBPipeline:
    ...
    def __init__(self):
        ...
        self.username = os.getenv('vaudeleteliott')

        self.password = os.getenv('Gruetaix?!3210')

        self.dbname = os.getenv('cluster1')

        self.mongodb_uri = os.getenv('mongodb+srv://vaudeleteliott:<db_password>@cluster1.9d0b1.mongodb.net/?retryWrites=true&w=majority&appName=Cluster1')
